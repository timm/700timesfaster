...
\begin{figure*}
    ...
    {
        \includegraphics[width=0.48\linewidth]{IST_0_Wahono.pdf}
        \includegraphics[width=0.48\linewidth]{IST_0_Hall.pdf}
        \label{fig: baseline}
    }   
    \quad
    \subfigure[Is aggressive undersampling useful? Comparison for \textbf{Code A}.]
    {
        \includegraphics[width=0.48\linewidth]{IST_4_Wahono.pdf}
        \includegraphics[width=0.48\linewidth]{IST_4_Hall.pdf}
        \label{fig:4th}
    }
    \quad
    \subfigure[Is continuous learning useful? Comparison for \textbf{Code S}.]
    {
        \includegraphics[width=0.48\linewidth]{IST_3_Wahono.pdf}
        \includegraphics[width=0.48\linewidth]{IST_3_Hall.pdf}
        \label{fig:3rd}
    }
    \quad
    \subfigure[Is uncertainty sampling useful? Comparison for \textbf{Code U}.]
    {
        \includegraphics[width=0.48\linewidth]{IST_2_Wahono.pdf}
        \includegraphics[width=0.48\linewidth]{IST_2_Hall.pdf}
        \label{fig:2nd}
    }
    \quad
    \subfigure[Is patient useful? Comparison for \textbf{Code P}.]
    {
        \includegraphics[width=0.48\linewidth]{IST_1_Wahono.pdf}
        \includegraphics[width=0.48\linewidth]{IST_1_Hall.pdf}
        \label{fig:1st}
    }
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=0.48\linewidth]{percentile_Hall.pdf}
    \includegraphics[width=0.48\linewidth]{percentile_Wahono.pdf}
...
\begin{figure}[th]
    \centering
    \includegraphics[width=\linewidth]{PoR.pdf}
