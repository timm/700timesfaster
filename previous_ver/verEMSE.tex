...
\title{How to Read Less: On the Benefit of Human-in-the-loop Incremental Learning for Systematic Literature Review%\thanks{Grants or other notes
...
\keywords{Active Learning\and Human-in-the-loop Incremental Learning\and Systematic Literature Review\and Software Engineering\and Primary Study Selection}
...
% \begin{figure}[t]
%     \centering
%     \includegraphics[width=0.6\linewidth]{primary_study_selection.pdf}
%     \caption{Primary study selection steps suggested by~\cite{keele2007guidelines}. In this work, we focus on the excluding irrelevant studies part.}
%     \label{fig: prime}
% \end{figure}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.48\linewidth]{Preprocessing.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.6\linewidth]{PoR.eps}
...
\begin{figure}[t]
    \centering
    \begin{minipage}[t]{.48\linewidth}
    \includegraphics[width=\linewidth]{Reviewcost.png}    
